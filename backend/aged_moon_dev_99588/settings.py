"""
Django settings for aged_moon_dev_99588 project.
...
ROOT_URLCONF = 'aged_moon_dev_99588.urls'
...
WSGI_APPLICATION = 'aged_moon_dev_99588.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_moon_dev_99588 API",
    "DESCRIPTION": "API documentation for aged_moon_dev_99588 App",
    "VERSION": "v1",
}
